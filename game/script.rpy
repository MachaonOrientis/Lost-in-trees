...
label splashscreen:
    ...
    show text "LOST IN TREES" with dissolve
    with Pause(2)
...
=======
            "Получен навий посох."
    r "Как давно я не слышала эти слова."
#    Послушай, коль и вправду хочешь отблагодарить, то не в службу, а в дружбу: найдешь поминальный пирожок, не ешь и не выкидывай, а мне принеси, хорошо?{w=3} И берегись того, в красной рубашке!

>>>>>>> 17ce65186cddd4468553c1c539c63490026f80a6
    return
...
<<<<<<< HEAD
    ...
    centered "На вещем камне написано:{p}{p}Направо пойдешь - к мертвым на обед попадешь. Как хочешь, так и понимай.{p}{p}Налево пойдешь - сердце тьмы найдешь. Хотя туда только по записи, так что не факт.{p}{p}Прямо пойдешь{p}{p}- а сам сходи и узнай, чего это я тут распинаюсь. Да еще и в рифму, мне за такое не платят"
        
=======

    "Похоже, вы смогли выбраться из топей"

    centered "На вещем камне написано:{p}{p}Направо пойдешь - к мертвым на обед попадешь. Как хочешь, так и понимай.{p}{p}Налево пойдешь - сердце тьмы найдешь. Хотя туда только по записи, так что не факт.{p}{p}Прямо пойдешь - а сам сходи и узнай.{p}{p}Чего это я тут распинаюсь. Да еще и в рифму! Vне за такое не платят"
...
=======
        "Использовать навий посох": #qte
            l "Ах...дочурка моя, девица красна. Сгубил ее этот лес, все силы выжал. А я, не смог уберечь ни лес, ни ее. Бедняжка руки на себя наложила. Навкой стала. Жалкий я дурень..."
#            l "Послушай, возьми водичку живую. Коль встретится она тебе, молю, плесни на нее. Она вновь в живую обратится. Я бы сам сходил... да не могу ей в очи смотреть ее навьи, укора и ненависти полные. "
#            l "От стыда в голове будто чаща от ветра дикого шумит."
            # смерть
...
#                 разумного существа! И тогда, я смилостивлюсь и не покараю тебя за твою дерзость, червь. И может даже выпущу отсюда. Обещаю, что выпущу"
                $ q.append(1)
                $ renpy.block_rollback()
                menu:
                    "Согласиться":
