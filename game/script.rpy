...
label label5:
    ...
    centered "На вещем камне написано:{p}{p}Направо пойдешь - к мертвым на обед попадешь. Как хочешь, так и понимай.{p}{p}Налево пойдешь - сердце тьмы найдешь. Хотя туда только по записи, так что не факт.{p}{p}Прямо пойдешь - а сам сходи и узнай.{p}{p}Чего это я тут распинаюсь. Да еще и в рифму! Мне за такое не платят."
...
label label9:
    ...
    t "Теперь ты будешь всегда ходить по этому кругу и развлекать меня, раз за разом исполняя одну и ту же пьесу. Да, реквизита здесь маловато, увы."
