...
label label9:
    ...
    t "Итак, круг замкнулся. Ты сделал петлю. И пришел ко мне. Снова."
    t "Ты спросишь, что же дальше? Ответ прост. Ты будешь ходить по одному и тому же кругу и играть одну и ту же пьесу вечно. Это развлекает меня. Увы, в этой пьесе не так уж много сцен."
    t "Но достаточно, чтобы держать тебя здесь, пока я заменяю тебя в твоем мире, преследуя свои амбициозные цели, скрываясь за фасадом твоего лица."

    show tricopen
    
    t "О, моя любимая часть представления. Видеть страх понимания в твоих глазах."
    t "Но не отчаивайся. Ты очень скоро все это забудешь. И вновь чист и полон надежд."
